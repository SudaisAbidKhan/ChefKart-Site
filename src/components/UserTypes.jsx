    ...
    <section id="usertypes" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
                ...
                <ul className="space-y-3 mb-8">
                  {u.perks.map(perk => (
                    <li key={perk} className="flex items-start gap-3">
                      <div className={`w-5 h-5 rounded-full bg-linear-to-br ${u.gradient} flex items-center justify-center flex-shrink-0 mt-0.5`}>
        ...
        <div className="mt-10 bg-gray-900 rounded-3xl p-8 flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
          <div className="w-16 h-16 bg-gray-700 rounded-2xl flex items-center justify-center text-4xl flex-shrink-0">🛡️</div>
